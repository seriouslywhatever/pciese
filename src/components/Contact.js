...
const Contact = () => {
    ...
    return (
        <div style={{ marginBottom: '5%' }}>
                ...
                <div style={{ flex: isBrowser ? 8 : 6 }}>
                    <nav className="nav">
                        <ul className="nav-links">
                            <li><Link style={{ fontSize: isBrowser ? '1.1vw' : '2.8vw' }} to="/">{t('Home')}</Link></li>
                            <li><Link to="/" style={{ fontSize: isBrowser ? '1.1vw' : '2.8vw', pointerEvents: 'none', color: 'gray' }}>{t('About Us')}</Link></li>
                            <li><Link to="/" style={{ fontSize: isBrowser ? '1.1vw' : '2.8vw', pointerEvents: 'none', color: 'gray' }}>{t('Services')}</Link></li>
            ...
            <div>
                <img src={banner} alt='contact' style={{ height: isBrowser? '35vh': '15vh', width: '100%', objectFit: 'cover' }} />
                <div className='section-heading'>
                    <span className="line"></span>
                    <h1 className='section-title' style={{ fontSize: isBrowser ? '2.2vw' : '6vw' }}>{t('Contact Us')}</h1>
                    <span className="line"></span>
                </div>
                <div style={{ justifyContent: 'center', display: 'flex' }}>
                    <Toaster
                        ...
                        reverseOrder={false}
                    />
                    <form ref={form} className="flex flex-col gap-6 " style={{ width: isBrowser? '40vw': '80%' }} onSubmit={sendEmail}>
                        <div>
